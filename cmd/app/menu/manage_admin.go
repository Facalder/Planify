...
func ManageManagerAdmin() {
	component.Header(putils.CenterText("Welcome to Manage Manager (Admin) Menu!, \n" +
	...
	for {
		...
		pterm.DefaultBasicText.Println("(4) - Remove Data Manager")

		pterm.DefaultSection.Println("Others Available Commands?")
		pterm.DefaultBasicText.Println("(5) - Back")
		pterm.DefaultBasicText.Println("(6) - Exit Program")
		...
		//})
		case "5":
			component.Spinner(pkg.Loading, "Leaving Manage Manager Menu....", func() {
				MenuAdmin()
			})
		case "6":
...
func ManageEmployeeAdmin() {
	component.Header(putils.CenterText("Welcome to Manage Employee (Admin) Menu!, \n" +
	...
	for {
		...
		pterm.DefaultBasicText.Println("(4) - Remove Data Employee")
		...
		//})
		case "5":
			component.Spinner(pkg.Loading, "Leaving Manage Employee Menu....", func() {
				MenuAdmin()
			})
		case "6":
			component.Spinner(pkg.ExitProgram, "Exiting Program, Please Wait a Second...", func() {
...
func ManageTaskAdmin() {
	component.Header(putils.CenterText("Welcome to Manage Task (Admin) Menu!, \n" +
		"Manage Your Employees to Work Harder, and Harder!"))
