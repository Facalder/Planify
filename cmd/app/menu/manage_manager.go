...
func ManageEmployeeManager() {
	component.Header(putils.CenterText("Welcome to Manage Employee (Manager) Menu!, \n" +
...
func ManageTaskManager() {
	component.Header(putils.CenterText("Welcome to Manage Task (Manager) Menu!, \n" +
		"Manage Your Employees to Work Harder, and Harder!"))
